...
| 字段 (Field) | 值 (Value) | 说明 (Description) |
|-------------|-----------|------------------|
| **开始时间** (Start Time) | 2025-10-20T13:50:14.773513 | 策略开始运行时间 |
| **结束时间** (End Time) | 2025-10-20T13:50:37.132292 | 策略结束运行时间 |
...
| **入场价格** (Entry Price) | $110,845.90 | 当前持仓的入场价格 |
...
|------|------|------|------|------|--------|------|
| 1 | 2025-10-20T13:50:16.479355 | buy_open | $110845.90 | 0.010000 | 0.00% | 2x |
