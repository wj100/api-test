...
| 字段 (Field) | 值 (Value) | 说明 (Description) |
|-------------|-----------|------------------|
| **开始时间** (Start Time) | 2025-10-20T13:50:43.890881 | 策略开始运行时间 |
| **结束时间** (End Time) | 2025-10-20T13:51:07.542393 | 策略结束运行时间 |
...
| **入场价格** (Entry Price) | $110,865.00 | 当前持仓的入场价格 |
...
|------|------|------|------|------|--------|------|
| 1 | 2025-10-20T13:50:45.560330 | buy_open | $110865.00 | 0.010000 | 0.00% | 2x |
