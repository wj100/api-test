...
| 字段 (Field) | 值 (Value) | 说明 (Description) |
|-------------|-----------|------------------|
| **开始时间** (Start Time) | 2025-10-20T14:01:27.699833 | 策略开始运行时间 |
| **结束时间** (End Time) | 2025-10-20T14:01:43.202833 | 策略结束运行时间 |
| **运行时长** (Runtime Hours) | 0.00小时 (0.3分钟) | 策略总运行时间 |
...
| **入场价格** (Entry Price) | $111,073.50 | 当前持仓的入场价格 |
...
|------|------|------|------|------|--------|------|
| 1 | 2025-10-20T14:01:29.392348 | buy_open | $111073.50 | 0.010000 | 0.00% | 2x |
