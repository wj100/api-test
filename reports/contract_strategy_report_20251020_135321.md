...
| 字段 (Field) | 值 (Value) | 说明 (Description) |
|-------------|-----------|------------------|
| **开始时间** (Start Time) | 2025-10-20T13:53:07.073973 | 策略开始运行时间 |
| **结束时间** (End Time) | 2025-10-20T13:53:21.475441 | 策略结束运行时间 |
...
| **入场价格** (Entry Price) | $110,800.60 | 当前持仓的入场价格 |
...
|------|------|------|------|------|--------|------|
| 1 | 2025-10-20T13:53:08.790677 | buy_open | $110800.60 | 0.010000 | 0.00% | 2x |
